    ...
    create: function () {
        ...
        /*for (var i = 0, j = this.enemies.length; i < j; i++) {
            ...
            var createEnemy1 = function () {
                var enemy = game.add.sprite(0, 0, "destroyer");
                ...
                if (tEnemy1.length != parseInt(self.attackInfo[i].substring(0, 2))) {
                    setTimeout(function () {
                        tEnemy1.add(enemy);
                        createEnemy1();
                    }, 2);
            ...
            var createEnemy2 = function(){
                var enemy = game.add.sprite(0,0,"hunter");
                ...
                if (tEnemy2.length != parseInt(self.attackInfo[i].substring(2, 4))) {
                    setTimeout(function () {
                        tEnemy2.add(enemy);
                        createEnemy2();
                    }, 2);
            ...
            var createEnemy3 = function(){
                var enemy = game.add.sprite(0,0,"commander");
                enemy.health = 2.5;
                enemy.maxHealth = 2.5;
                ...
                if (tEnemy3.length != parseInt(self.attackInfo[i].substring(4, 4))) {
                    setTimeout(function () {
                        tEnemy3.add(enemy);
                        createEnemy3();
                    }, 2);
